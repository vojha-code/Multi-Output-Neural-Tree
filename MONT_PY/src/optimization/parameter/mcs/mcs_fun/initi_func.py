...
from src.optimization.parameter.mcs.mcs_fun.sign import sign
#------------------------------------------------------------------------------
def subint(x1, x2):
    '''
...
#------------------------------------------------------------------------------
from src.optimization.parameter.mcs.mcs_fun.genbox import genbox
from src.optimization.parameter.mcs.mcs_fun.polint import polint
from src.optimization.parameter.mcs.mcs_fun.quadratic_func import quadmin
from src.optimization.parameter.mcs.mcs_fun.quadratic_func import quadpol
#------------------------------------------------------------------------------
